...
export function inicializarCarrinho() {
    ...
    const bataoAbrirCarrinho = document.getElementById("abrir-carrinho")
    const botaoIrParaCheckout = document.getElementById("finalizar-compra")

    botaoFecharCarrinho.addEventListener('click', fecharCarrinho)
    bataoAbrirCarrinho.addEventListener('click', abrirCarrinho)
...
function desenharProdutoNoCarrinho(idProduto) {    
    ...
    <img src="./assets/imagem/${produto.imagem}" alt="Carrinho: ${produto.nome}" class="h-24 rounded-lg">        
