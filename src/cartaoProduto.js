...
export function renderizarCatalogo() {
    for (const produtoCatalogo of catalogo) { 
        const cartaoProduto = `<div class='border-solid w-48 m-2 flex flex-col p-2 justify-between shadow-xl shadow-slate-400 rounded-lg group ${produtoCatalogo.disney ? 'disney' : 'huacan'}' id="card-produto-${produtoCatalogo.id}">
        <img
         src="./assets/imagem/${produtoCatalogo.imagem}"
         alt="Produto 1 da Import Azoia."
